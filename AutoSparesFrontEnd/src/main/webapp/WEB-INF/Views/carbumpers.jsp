...
<img src="${img}/${pro.getProductID()}.jpg" width="250px" height="250px">
<h3>${pro.getName()}</h3>
<p>${pro.getDescription()}</p>
<h4>${pro.getPrice() }Rs</h4>
<div class="button"><span><a href="<c:url value="/singlepage/${pro.getProductID()}"/>">Read More</a></span></div>
</div>
</c1:forEach>
